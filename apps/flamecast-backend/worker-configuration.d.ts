/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env-file .env.example` (hash: 2edc91772ac745fd3fb7b13862a303e9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKOS_API_KEY" | "WORKOS_CLIENT_ID" | "WORKOS_COOKIE_PASSWORD" | "WORKOS_REDIRECT_URI" | "DATABASE_URL" | "POOLED_DATABASE_URL" | "POSTHOG_KEY" | "POSTHOG_HOST" | "SMITHERY_API_KEY" | "AGENTMAIL_API_KEY" | "AGENTMAIL_INBOX_ID">> {}
}
declare module "*.md" {
	const value: string;
